...
libtaskcmdl:
	$C -c -fpic src/taskcmdl.c -o lib/taskcmdl.o
	$C -shared lib/taskcmdl.o -o lib/libtaskcmdl.so

taskd: libmessage libtaskcmdl
	$C lib/message.o lib/taskcmdl.o src/taskd.c -o bin/taskd
